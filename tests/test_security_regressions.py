...
# ---------------------------------------------------------------------------
# !. A user must not be able to reorder another user's MinorStage.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2. A Medium owned by User A must not be linked to User B's MinorStage.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 3. An Activity must not be updated through a different MinorStage,
...
# ---------------------------------------------------------------------------
# 4. User A must not create a Place using User B's CustomCountry.
# ---------------------------------------------------------------------------
