...
class CountryValidation(Validation):
  ...
  def validate_custom_country_update(country):
        ...
        if CountryValidation().validate_string(country['best_time_to_visit']['value'], min_length=0, max_length=300):
        ...
        if CountryValidation().validate_string(country['general_information']['value'], min_length=0, max_length=600):
